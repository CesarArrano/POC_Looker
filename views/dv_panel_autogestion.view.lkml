view: dv_panel_autogestion {
  sql_table_name: `DATAMART_MOSS.DV_PANEL_AUTOGESTION`
    ;;
  ...
  dimension: contribucion_numerador {
    type: number
    sql: ${TABLE}.CONTRIBUCION_NUMERADOR ;;
  }
  ...
  dimension: incidencia {
    type: number
    sql: ${TABLE}.INCIDENCIA ;;
  }

  dimension: incidencia_denominador {
    type: number
    sql: ${TABLE}.INCIDENCIA_DENOMINADOR ;;
  }

  dimension: incidencia_numerador {
    type: number
    sql: ${TABLE}.INCIDENCIA_NUMERADOR ;;
  }
  ...
  dimension: qpaxafectado {
    type: number
    sql: ${TABLE}.QPAXAFECTADO ;;
  }
