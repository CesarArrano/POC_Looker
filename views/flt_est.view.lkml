view: flt_est {
  sql_table_name: `DATAMART_MOSS.flt_est`
    ;;
  ...
  dimension: etba_cargo_peso {
    type: number
    sql: ${TABLE}.ETBA_CARGO_PESO ;;
  }

  dimension: etba_cdg_matricula {
    type: string
    sql: ${TABLE}.ETBA_CDG_MATRICULA ;;
  }

  dimension: etba_cnt_bags {
    type: number
    sql: ${TABLE}.ETBA_CNT_BAGS ;;
  }

  dimension: etba_cnt_paidload_max {
    type: number
    sql: ${TABLE}.ETBA_CNT_PAIDLOAD_MAX ;;
  }

  dimension: etba_cnt_paidload_real {
    type: number
    sql: ${TABLE}.ETBA_CNT_PAIDLOAD_REAL ;;
  }

  dimension: etba_cnt_pax_j {
    type: number
    sql: ${TABLE}.ETBA_CNT_PAX_J ;;
  }

  dimension: etba_cnt_pax_p {
    type: number
    sql: ${TABLE}.ETBA_CNT_PAX_P ;;
  }

  dimension: etba_cnt_pax_y {
    type: number
    sql: ${TABLE}.ETBA_CNT_PAX_Y ;;
  }

  dimension: etba_cnt_peso_bags {
    type: number
    sql: ${TABLE}.ETBA_CNT_PESO_BAGS ;;
  }

  dimension: etba_cnt_peso_pax {
    type: number
    sql: ${TABLE}.ETBA_CNT_PESO_PAX ;;
  }

  dimension: etba_cnt_tow_estb {
    type: number
    sql: ${TABLE}.ETBA_CNT_TOW_ESTB ;;
  }

  dimension: etba_cnt_tow_real {
    type: number
    sql: ${TABLE}.ETBA_CNT_TOW_REAL ;;
  }

  dimension: etba_cnt_zfw_real {
    type: number
    sql: ${TABLE}.ETBA_CNT_ZFW_REAL ;;
  }

  dimension: etba_prc_maclw {
    type: number
    sql: ${TABLE}.ETBA_PRC_MACLW ;;
  }

  dimension: etba_prc_mactow {
    type: number
    sql: ${TABLE}.ETBA_PRC_MACTOW ;;
  }

  dimension: etba_prc_maczfw {
    type: number
    sql: ${TABLE}.ETBA_PRC_MACZFW ;;
  }

  dimension: etba_sign_in {
    type: number
    sql: ${TABLE}.ETBA_SIGN_IN ;;
  }

  dimension: etba_status_flt {
    type: string
    sql: ${TABLE}.ETBA_STATUS_FLT ;;
  }

  dimension: etba_thru_peso {
    type: number
    sql: ${TABLE}.ETBA_THRU_PESO ;;
  }

  dimension: etba_underl_peso {
    type: number
    sql: ${TABLE}.ETBA_UNDERL_PESO ;;
  }
