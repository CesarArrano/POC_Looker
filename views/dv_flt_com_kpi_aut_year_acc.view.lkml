view: dv_flt_com_kpi_aut_year_acc {
  sql_table_name: `DATAMART_MOSS.dv_flt_com_kpi_aut_year_acc`
    ;;
  ...
  dimension: business_detail_level_3 {
    type: string
    sql: ${TABLE}.business_detail_level_3 ;;
  }
