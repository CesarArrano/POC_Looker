view: desa_flt_com_bkg_tkt_cus {
  sql_table_name: `DATAMART_MOSS.desa_flt_com_bkg_tkt_cus`
    ;;
  ...
  dimension_group: date_real_arrival {
    type: time
    timeframes: [
      raw,
      date,
    ...
    convert_tz: no
    datatype: date
    sql: ${TABLE}.date_real_arrival ;;
  }

  dimension_group: date_real_dt {
    type: time
    timeframes: [
      raw,
      date,
  ...
  dimension: delay_real_programmed_minutes {
    type: number
    sql: ${TABLE}.delay_real_programmed_minutes ;;
  }
